document.addEventListener('DOMContentLoaded', () => {
    ...
    // Daftar Lagu (DIPERBARUI DENGAN 10 LAGU)
    const songs = [
        ...
        { name: 'Penjaga Api Suci', path: 'audio/Penjaga Api Suci.mp3' }, // <-- LAGU BARU
        { name: 'Edifikasi & Duplikasi', path: 'audio/Edifikasi & Duplikasi.mp3' } // <-- LAGU BARU
    ];
