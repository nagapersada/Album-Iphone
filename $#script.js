document.addEventListener('DOMContentLoaded', () => {
    ...
    const songs = [
        ...
        { name: 'Edifikasi & Duplikasi', path: 'audio/Edifikasi & Duplikasi.mp3' },
        { name: 'Gema Edukasi OPALP', path: 'audio/Gema Edukasi OPALP.mp3' }
    ];
    ...
    // 4. Navigasi Slide (Fungsi Fullscreen Dihapus untuk iPhone)
    enterBtn.addEventListener('click', () => {
        
        // Kode Fullscreen Dihapus dari sini
        
        slide1.classList.remove('active');
        slide2.classList.add('active');
        
        if(currentSongIndex === -1) {
             playSong(0); // Ini sekarang akan diizinkan oleh iPhone
        }
    });
    ...
    backBtn.addEventListener('click', () => {
        ...
        // Kode exitFullscreen Dihapus dari sini
    });
